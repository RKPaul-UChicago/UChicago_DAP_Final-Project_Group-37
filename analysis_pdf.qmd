---
title: "Who Votes in Chicago?<br>Participation and Representativeness in Presidential Elections, 2008–2024"
...
### 8.3 Turnout vs Socioeconomic index by year

```{python}
#| label: fig-turnout vs SES Index
...
### 8.4 Two-way Fixed Effects Panel Regression
...
### 8.5 Turnout by Income Quintile

```{python}
#| label: fig-income-quintile
#| fig-cap: "Average turnout rate by income quintile and election year"
...
- **Income & Education:** Income and education show the strongest and most consistent positive correlations with turnout. Precincts with higher shares of college educated residents and higher income levels consistently exhibit higher turnout rates than others. This gap persists across all five elections (2008 - 2024).

- **Youth Share:** Precincts with more residents aged 18–29 tend to show lower turnout, consistent with national patterns of lower youth participation.

- **Renter Share:** Consistently negatively correlated with turnout. Residential mobility disrupts registration and weakens the community ties that facilitate political participation.

- **Racial Composition:** In 2008 (Obama's first run), majority-Black precincts showed elevated turnout relative to other years – consistent with candidate-driven mobilization. In other cycles, higher minority share generally correlates with lower turnout, reflecting structural barriers.

### Policy Implications and Recommendations
- Turnout inequality remains spatially persistent across Chicago neighborhoods

- Lower socioeconomic neighborhoods face greater barriers to participation

- Education is the most consistent predictor of turnout differences

- This suggests a civic engagement gap rather than purely financial constraints

- **Target civic engagement efforts in low-SES precincts through as these reduce the barriers that education indirectly captures:**
...
- **Civic education**
programs that explain voting processes
...
- Analysis identifies associations, not causal effects

- Area-weighted spatial interpolation may introduce some estimation uncertainty in precinct demographic characteristics
