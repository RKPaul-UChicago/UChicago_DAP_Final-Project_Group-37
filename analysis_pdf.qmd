...
author: "Group 37: Rajat Kanti Paul (section, time, gitname) and Sakkhi Raheel"
date: "March 09, 2026"
format:
  pdf:
    toc: false
...
Understanding these patterns has practical implications for policymakers, civic organizations, and election administrators. If participation gaps are concentrated in particular types of neighborhoods, targeted policies and civic engagement strategies may help reduce barriers to participation and strengthen democratic representation. By analyzing turnout across five presidential elections that capture varying turnout environments and political contexts, this project provides a long-term perspective on how participation patterns persist across time and how they relate to structural neighborhood characteristics.
...
Together, these data allow us to examine how turnout varies spatially across Chicago and how strongly participation is associated with neighborhood characteristics.
...
Our project combines static visual analysis with an interactive dashboard that allows users to explore turnout patterns in greater detail.

The static figures presented in this report highlight the most important descriptive findings from the dataset. These visualizations illustrate spatial turnout patterns, the relationship between turnout and socioeconomic status, and how demographic correlations with turnout evolve across election cycles.

In addition to these figures, our dashboard allows users to interactively explore turnout patterns by election year, compare demographic indicators across precincts, and visualize spatial variation in participation across the city. By allowing users to examine the data directly, the dashboard complements the static report and provides a flexible tool for exploring Chicago’s electoral geography.

Potential users of the dashboard include students, researchers, civic organizations, and policymakers interested in voter participation patterns. The dashboard is designed to make the underlying data more accessible and to allow users to explore how turnout varies across neighborhoods and election cycles.
...
To explore whether neighborhood socioeconomic conditions are associated with voter participation, we examine the relationship between turnout and the SES index across election years The scatter plots show a clear and consistent positive relationship between socioeconomic status and turnout. Precincts with higher SES scores tend to exhibit higher turnout rates, while precincts with lower SES scores generally show lower participation.

This relationship appears in every election cycle in our dataset. While turnout increases during highly competitive elections, the relative gap between high-SES and low-SES precincts remains visible.These results suggest that socioeconomic conditions are strongly associated with participation. Neighborhood characteristics such as income levels, educational attainment, and housing stability likely shape both the resources and institutional familiarity that facilitate political engagement.
...
Finally, we examine how turnout correlates with several demographic characteristics across election cycles. The heatmap visualization summarizes correlations between turnout and demographic variables for each election year.

Several patterns emerge clearly. Income and education show the strongest and most consistent positive relationships with turnout across election cycles. Precincts with higher household incomes and higher shares of college-educated residents consistently exhibit higher participation. By contrast, precincts with higher shares of renters or younger residents tend to show lower turnout rates. These patterns are consistent with broader national trends in political participation. One notable exception occurs in 2008, when majority-Black precincts experienced relatively higher turnout compared to other years. This pattern likely reflects the unique mobilization dynamics surrounding Barack Obama’s first presidential campaign.
...
In addition to the static analysis presented in this report, we developed an interactive dashboard that allows users to explore Chicago’s voter turnout patterns across precincts and election years. The dashboard enables users to visualize spatial variation in turnout, examine relationships between turnout and neighborhood demographics, and compare patterns across communities.
