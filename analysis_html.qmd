...
def make_turnout_choropleth(gdf, year):
    ...
    # Stroke-only layer to highlight precinct borders
    borders = base.mark_geoshape(
        fillOpacity=0.0,
        stroke='black',       # or a dark grey like '#333333'
        strokeWidth=0.7
    )

    return (fill + borders).properties(
        width=180, height=280, title=str(year)
    )
